...
export const metadata = {
  title: 'Jacob Brewer — President & CEO | The GTC Group',
        ...
        <div className="relative z-10 max-w-[1000px] mx-auto px-6 md:px-10">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start">
            ...
            <div className="relative w-[160px] h-[200px] md:w-[200px] md:h-[250px] flex-shrink-0 overflow-hidden">
              <Image
                src="/team/team-1.png"
                alt="Jacob Brewer — President & CEO of The GTC Group"
                fill
            ...
            <div className="flex-1">
              <div className="font-display text-[11px] font-semibold tracking-[0.2em] uppercase text-gold-500 mb-3">President & CEO</div>
