...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* Intro / About */}
      <section id="about" className="relative py-16 md:py-[100px] bg-cream-100">
        ...
        <div className="max-w-[1200px] mx-auto px-5 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <div className="lg:pr-5">
              ...
              <p className="text-[15px] md:text-[16px] text-gray-600 leading-[1.7] md:leading-[1.8] mb-4 md:mb-[18px]">
            ...
            <div className="relative mx-4 md:mx-0">
              ...
              />
              <div className="absolute -top-3 -right-3 md:-top-4 md:-right-4 w-full h-full border-[3px] border-gold-500 rounded -z-10" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-[100px] bg-white">
        <div className="max-w-[1200px] mx-auto px-5 md:px-6 text-center">
          ...
          <p className="text-[15px] md:text-[17px] text-gray-600 max-w-[640px] mx-auto leading-[1.7] mb-10 md:mb-[60px]">
            Independent carriers face systemic disadvantages in the logistics industry. We eliminate them.
          </p>
          
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_60px_1fr] gap-6 lg:gap-8 items-stretch">
            {/* Problem Card */}
            <div className="bg-gradient-to-br from-gray-100 to-gray-200 border-l-4 border-gray-500 rounded p-6 md:p-11 text-left">
              <h3 className="font-display text-[clamp(1.15rem,2.5vw,1.625rem)] text-navy-900 font-bold leading-[1.3] tracking-[-0.02em] mb-3 md:mb-4">The Problem</h3>
              <p className="text-[14px] md:text-[15px] text-gray-600 mb-4 md:mb-5">As an independent carrier, you&apos;re at a disadvantage from day one:</p>
              <ul className="space-y-0">
                <li className="py-2.5 md:py-[10px] pl-6 relative text-[14px] md:text-[15px] text-gray-700 border-b border-black/[0.06] before:content-['→'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Paying premium rates for insurance, fuel, and maintenance</li>
                <li className="py-2.5 md:py-[10px] pl-6 relative text-[14px] md:text-[15px] text-gray-700 border-b border-black/[0.06] before:content-['→'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Limited access to high-value lanes and direct shipper relationships</li>
                <li className="py-2.5 md:py-[10px] pl-6 relative text-[14px] md:text-[15px] text-gray-700 border-b border-black/[0.06] before:content-['→'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Competing against mega-carriers with deeper resources</li>
                <li className="py-2.5 md:py-[10px] pl-6 relative text-[14px] md:text-[15px] text-gray-700 border-b border-black/[0.06] before:content-['→'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">No leverage to renegotiate existing contracts</li>
                <li className="py-2.5 md:py-[10px] pl-6 relative text-[14px] md:text-[15px] text-gray-700 before:content-['→'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Marketing and sales stretched thin while you focus on operations</li>
              </ul>
            </div>

            {/* Arrow */}
            <div className="flex items-center justify-center lg:rotate-0 rotate-90 py-2 lg:py-0">
              <svg className="w-8 h-8 md:w-10 md:h-10 text-gold-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                <path d="M5 12h14M12 5l7 7-7 7"/>
              </svg>
            </div>

            {/* Solution Card */}
            <div className="bg-gradient-to-br from-navy-900 to-navy-700 border-l-4 border-gold-500 rounded p-6 md:p-11 text-left">
              <h3 className="font-display text-[clamp(1.15rem,2.5vw,1.625rem)] text-white font-bold leading-[1.3] tracking-[-0.02em] mb-3 md:mb-4">The GTC Solution</h3>
              <p className="text-[14px] md:text-[15px] text-white/80 mb-4 md:mb-5">We pool carrier resources to give you enterprise-level advantages:</p>
              <ul className="space-y-0">
                <li className="py-2.5 md:py-[10px] pl-6 relative text-[14px] md:text-[15px] text-white border-b border-white/10 before:content-['→'] before:absolute before:left-0 before:text-gold-400 before:font-semibold">Bulk-negotiated rates on insurance, fuel, maintenance, and driver services</li>
                <li className="py-2.5 md:py-[10px] pl-6 relative text-[14px] md:text-[15px] text-white border-b border-white/10 before:content-['→'] before:absolute before:left-0 before:text-gold-400 before:font-semibold">Dedicated sales team finding and securing profitable lanes on your behalf</li>
                <li className="py-2.5 md:py-[10px] pl-6 relative text-[14px] md:text-[15px] text-white border-b border-white/10 before:content-['→'] before:absolute before:left-0 before:text-gold-400 before:font-semibold">Direct connections to shippers—cutting out unnecessary middlemen</li>
                <li className="py-2.5 md:py-[10px] pl-6 relative text-[14px] md:text-[15px] text-white border-b border-white/10 before:content-['→'] before:absolute before:left-0 before:text-gold-400 before:font-semibold">Renegotiation of your current contracts for immediate savings</li>
                <li className="py-2.5 md:py-[10px] pl-6 relative text-[14px] md:text-[15px] text-white before:content-['→'] before:absolute before:left-0 before:text-gold-400 before:font-semibold">Professional website, marketing, and online presence management</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      {/* Services */}
      <section id="services" className="py-16 md:py-[100px] bg-gray-100">
        <div className="max-w-[1200px] mx-auto px-5 md:px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-7">
            ...
            <div className="animate-on-scroll bg-white rounded shadow-md p-6 md:p-10 text-left relative overflow-hidden group hover:-translate-y-1.5 hover:shadow-xl transition-all duration-300 before:absolute before:top-0 before:left-0 before:right-0 before:h-[3px] before:bg-gold-500 before:scale-x-0 hover:before:scale-x-100 before:transition-transform before:duration-300">
              ...
              <p className="text-[13px] md:text-[14px] text-gray-600 leading-[1.7] mb-4 md:mb-5">Leverage our collective buying power to access rates typically reserved for large fleets.</p>
              <ul className="space-y-1 md:space-y-1.5 mb-4 md:mb-[18px]">
                <li className="py-1 md:py-1.5 pl-[18px] relative text-[13px] md:text-[14px] text-gray-700 before:content-['✓'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Insurance procurement & optimization</li>
                <li className="py-1 md:py-1.5 pl-[18px] relative text-[13px] md:text-[14px] text-gray-700 before:content-['✓'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Bulk fuel purchasing programs</li>
                <li className="py-1 md:py-1.5 pl-[18px] relative text-[13px] md:text-[14px] text-gray-700 before:content-['✓'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Maintenance network access</li>
                <li className="py-1 md:py-1.5 pl-[18px] relative text-[13px] md:text-[14px] text-gray-700 before:content-['✓'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Driver services & recruitment</li>
                <li className="py-1 md:py-1.5 pl-[18px] relative text-[13px] md:text-[14px] text-gray-700 before:content-['✓'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Equipment financing</li>
              </ul>
            ...
            <div className="animate-on-scroll bg-white rounded shadow-md p-6 md:p-10 text-left relative overflow-hidden group hover:-translate-y-1.5 hover:shadow-xl transition-all duration-300 before:absolute before:top-0 before:left-0 before:right-0 before:h-[3px] before:bg-gold-500 before:scale-x-0 hover:before:scale-x-100 before:transition-transform before:duration-300">
              ...
              <p className="text-[13px] md:text-[14px] text-gray-600 leading-[1.7] mb-4 md:mb-5">Our sales team works to expand your business and maximize your rates.</p>
              <ul className="space-y-1 md:space-y-1.5 mb-4 md:mb-[18px]">
                <li className="py-1 md:py-1.5 pl-[18px] relative text-[13px] md:text-[14px] text-gray-700 before:content-['✓'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Dedicated sales representation</li>
                <li className="py-1 md:py-1.5 pl-[18px] relative text-[13px] md:text-[14px] text-gray-700 before:content-['✓'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Lane acquisition & optimization</li>
                <li className="py-1 md:py-1.5 pl-[18px] relative text-[13px] md:text-[14px] text-gray-700 before:content-['✓'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Direct shipper connections</li>
                <li className="py-1 md:py-1.5 pl-[18px] relative text-[13px] md:text-[14px] text-gray-700 before:content-['✓'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Rate renegotiation services</li>
                <li className="py-1 md:py-1.5 pl-[18px] relative text-[13px] md:text-[14px] text-gray-700 before:content-['✓'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Contract management</li>
              </ul>
            ...
            <div className="animate-on-scroll bg-white rounded shadow-md p-6 md:p-10 text-left relative overflow-hidden group hover:-translate-y-1.5 hover:shadow-xl transition-all duration-300 before:absolute before:top-0 before:left-0 before:right-0 before:h-[3px] before:bg-gold-500 before:scale-x-0 hover:before:scale-x-100 before:transition-transform before:duration-300">
              ...
              <p className="text-[13px] md:text-[14px] text-gray-600 leading-[1.7] mb-4 md:mb-5">Professional presence to compete with established carriers.</p>
              <ul className="space-y-1 md:space-y-1.5 mb-4 md:mb-[18px]">
                <li className="py-1 md:py-1.5 pl-[18px] relative text-[13px] md:text-[14px] text-gray-700 before:content-['✓'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Professional website design</li>
                <li className="py-1 md:py-1.5 pl-[18px] relative text-[13px] md:text-[14px] text-gray-700 before:content-['✓'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Online reputation management</li>
                <li className="py-1 md:py-1.5 pl-[18px] relative text-[13px] md:text-[14px] text-gray-700 before:content-['✓'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Marketing strategy & execution</li>
                <li className="py-1 md:py-1.5 pl-[18px] relative text-[13px] md:text-[14px] text-gray-700 before:content-['✓'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Digital presence optimization</li>
                <li className="py-1 md:py-1.5 pl-[18px] relative text-[13px] md:text-[14px] text-gray-700 before:content-['✓'] before:absolute before:left-0 before:text-gold-500 before:font-semibold">Brand identity development</li>
              </ul>
        ...
        <div className="relative z-[2] max-w-[1200px] mx-auto px-5 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-[72px] items-center">
            <div>
              ...
              <p className="text-[15px] md:text-[16px] text-white/75 leading-[1.7] md:leading-[1.8] mb-6 md:mb-7">
            ...
            <div className="bg-white/[0.04] border-2 border-gold-500 rounded-md p-6 md:p-9 text-center">
              ...
              <h3 className="font-display text-[1.25rem] md:text-[1.5rem] text-white font-bold leading-[1.3] tracking-[-0.02em] mb-3 md:mb-3.5">1-Week Money-Back Guarantee</h3>
      ...
      {/* Process */}
      <section id="process" className="py-16 md:py-[100px] bg-white">
        <div className="max-w-[1200px] mx-auto px-5 md:px-6 text-center">
